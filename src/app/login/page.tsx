  ...
  return (
    <div className="min-h-dvh bg-bg flex flex-col items-center justify-center px-4 py-10">
      ...
      <div className="flex items-center gap-2.5 mb-8">
        <div className="w-9 h-9 bg-gradient-to-br from-brand-blue-hover to-blue-700 rounded-[9px] flex items-center justify-center shadow-[0_2px_10px_rgba(37,99,235,.4)]">
          <CreditCard className="w-[18px] h-[18px] text-white" />
        </div>
        <span className="text-[20px] font-extrabold text-navy tracking-tight">
      ...
      <div className="w-full max-w-[380px] bg-surface border border-border rounded-card shadow-card overflow-hidden">
        ...
        <div className="flex border-b border-border">
          <button
            ...
            className={`flex-1 py-3.5 text-[13px] font-bold text-center border-b-2 transition-colors ${
              mode === 'login'
          ...
          {success ? (
            <div className="text-center py-4">
              ...
              <button
                ...
                className="text-[13px] font-bold text-brand-blue hover:text-brand-blue-hover transition-colors"
              >
                Ga naar inloggen →
              </button>
            </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                {mode === 'register' && (
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Bijv. Samba Jarju"
                      className="w-full px-3.5 py-2.5 border border-border rounded-lg text-[13px] text-txt bg-surface outline-none focus:border-brand-blue-hover transition-colors font-sans placeholder:text-muted-light"
                      autoComplete="name"
                    />
                  </div>
                )}
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      minLength={6}
                      className="w-full px-3.5 py-2.5 pr-10 border border-border rounded-lg text-[13px] text-txt bg-surface outline-none focus:border-brand-blue-hover transition-colors font-sans placeholder:text-muted-light"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-navy text-white text-[13px] font-bold hover:bg-navy-light disabled:opacity-60 transition-colors"
                >
                  {loading ? (
      ...
      {/* Footer */}
      <p className="text-[11.5px] text-muted-light mt-6">
        Huishoudelijke financiën overzichtelijk beheerd
      </p>
    </div>
  )
}
