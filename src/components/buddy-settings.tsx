...
const ROLE_LABEL_KEYS: Record<string, string> = {
  partner: 'rolePartner',
  ouder: 'roleParent',
  schuldhulpmaatje: 'roleDebtHelper',
  anders: 'roleOther',
};
            ...
            return (
              <div key={b.id} className="flex items-center gap-3 px-4 py-3 border-b border-pw-blue/10 last:border-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-pw-muted capitalize">{t(ROLE_LABEL_KEYS[b.role] || b.role) || b.role}</p>
                </div>
              ...
              <div key={b.id} className="px-4 py-3 border-b border-pw-border/50 last:border-0">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-pw-muted">{t(ROLE_LABEL_KEYS[b.role] || b.role) || b.role}</p>
                  </div>
        ...
        <div className="rounded-card border border-pw-border bg-pw-surface">
          ...
          {pending.map((b) => (
            <div key={b.id} className="flex items-center gap-3 px-4 py-3 border-b border-pw-border/50 last:border-0">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[12px] font-semibold text-pw-text">{t(ROLE_LABEL_KEYS[b.role] || b.role) || b.role}</p>
