...
export default function BulkBar({ count, onMarkPaid, onDeselect }: BulkBarProps) {
  ...
  return (
    <div className="flex items-center gap-2.5 px-4 md:px-5 py-2.5 bg-brand-blue-pale border-b border-brand-blue-mid">
      ...
      <button
        onClick={onMarkPaid}
        className="flex items-center gap-1.5 px-3 py-[5px] rounded-md border border-brand-blue-mid bg-surface text-brand-blue text-[12px] font-semibold hover:bg-brand-blue-mid transition-colors"
      >
