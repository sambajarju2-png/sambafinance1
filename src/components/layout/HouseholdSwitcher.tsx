...
interface HouseholdSwitcherProps {
  active: Household
  onChange: (hh: Household) => void
  partnerName: string
}

const TABS: { id: Household; dot: string }[] = [
  { id: 'joint', dot: '#2563EB' },
  { id: 'mine', dot: '#059669' },
  { id: 'partner', dot: '#7C3AED' },
]

function getLabel(id: Household, partnerName: string): string {
  switch (id) {
    case 'joint': return 'Samen'
    case 'mine': return 'Samba'
