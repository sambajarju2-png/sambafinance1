...
export default function SplashScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Wordmark */}
      <h1 className="splash-wordmark text-[28px] font-bold tracking-tight text-white">
        PayWatch
      </h1>
      ...
      <style jsx>{`
        .splash-logo {
          animation: splashBounceIn 0.6s cubic-bezier(0.22, 1, 0.36, 1) both;
        }
        .splash-wordmark {
          animation: splashFadeUp 0.5s cubic-bezier(0.22, 1, 0.36, 1) 0.3s both;
        }
        .splash-tagline {
          animation: splashFadeUp 0.5s cubic-bezier(0.22, 1, 0.36, 1) 0.5s both;
        }
        .splash-dot {
